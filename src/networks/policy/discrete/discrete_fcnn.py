...
# 이산적 정책 네트워크
class DiscreteFCNNPolicyNetwork(nn.Module):
    def __init__(self, config: dict, fc_dims: Optional[list] = None, args: argparse.Namespace = None):
        super().__init__()
        ...
        self._config = get_config(self, COFNIG_IGNORE)
