...
from src.common.base_class import BaseAlgorithm
from src.common.buffers import DictReplayBuffer, ReplayBuffer
from src.common.callbacks import BaseCallback
from src.common.noise import ActionNoise, VectorizedActionNoise
from src.common.policies import BasePolicy
from src.common.save_util import load_from_pkl, save_to_pkl
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    :param optimize_memory_usage: Enable a memory efficient variant of the replay buffer
        at a cost of more complexity. # ?? 무슨 기능?
