...
from src.common.preprocessing import is_image_space, is_image_space_channels_first
...
class StackedObservations(Generic[TObs]):
    ...
    :param channels_order: If "first", stack on first image dimension. If "last", stack on last dimension.
        ...
        # torch 에서 frame을 쌓아서 1D CNN 과 같은 모델을 사용할 때는 channels_order를 'last'로 설정해야 함.
        # 즉, (batch, n_stack, n_features) 형태로 쌓아야 함. vec_env 라면 (n_envs, batch, n_stack, n_features) 형태.
        # 이 때 n_stack이 channel 역할을 함.
    """
