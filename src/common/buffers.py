...
from src.common.preprocessing import get_action_dim, get_obs_shape
from src.common.type_aliases import (
...
from src.common.vec_env import VecNormalize
...
class BaseBuffer(ABC):
    ...
    def swap_and_flatten(arr: np.ndarray) -> np.ndarray:
        ...
        # 출력: [[1, 2, 3, 7, 8, 9], [4, 5, 6, 10, 11, 12]]

        아마도 백터 환경에서 사용되는 것 같음.
...
class ReplayBuffer(BaseBuffer):
    ...
    :param optimize_memory_usage: Enable a memory efficient variant
        ...
        # next_observation을 observation의 pos + 1의 위치에 넣어주어서 메모리를 절약
...
class DictReplayBuffer(ReplayBuffer):
    ...
    Dict replaybuffer가 사용되는 목적과 상황 알아보기
    """
